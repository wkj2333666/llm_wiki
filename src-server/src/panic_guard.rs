//! Panic-to-error boundary for command handlers.
//!
//! Third-party parsers (pdf-extract / lopdf, docx-rs, calamine, …) are
//! known to panic on malformed input instead of returning Err.
//! These helpers catch panics at the command boundary and convert them
//! into an error the frontend can display.
